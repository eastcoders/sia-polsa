...
namespace App\Filament\Dosen\Resources\Finance\FeeComponents;

use App\Filament\Dosen\Resources\Finance\FeeComponents\Pages;
...
class FeeComponentResource extends Resource
{
    ...
    {
        // Only visible to users with role 'keuangan' based on User request
