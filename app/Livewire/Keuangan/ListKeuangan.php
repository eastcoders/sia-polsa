...
class ListKeuangan extends Component implements HasActions, HasSchemas, HasTable
{
    ...
    {
        return $table
            ->query(fn(): Builder => User::query()->role('keuangan'))
            ->columns([
            ...
            ->headerActions([
                Action::make('add_keuangan')
                    ->label('Tambah User Keuangan')
                    ...
                    ->action(function (array $data) {
                        ...
                        if (!$user->hasRole($role)) {
                            ...
                            Notification::make()->title('Akses Keuangan Berhasil Ditambahkan')->success()->send();
                        } else {
                            Notification::make()->title('User ini sudah memiliki akses Keuangan')->warning()->send();
                        }
                    })
            ])
            ->recordActions([
                DeleteAction::make()
                    ...
                    ->modalHeading('Hapus Akses Keuangan?')
                    ->modalDescription('User ini tidak akan bisa mengakses menu Keuangan lagi, namun akun User tetap ada.')
                    ->action(function (User $record) {
                        $record->removeRole('keuangan');
                        Notification::make()->title('Akses Keuangan Dihapus')->success()->send();
                    })
            ])
            ->toolbarActions([
                //
    ...
    {
        return view('livewire.keuangan.list-keuangan');
    }
}
