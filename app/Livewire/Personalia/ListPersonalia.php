...
namespace App\Livewire\Personalia;
...
class ListPersonalia extends Component implements HasActions, HasSchemas, HasTable
{
    ...
    {
        return $table
            ->query(fn(): Builder => User::query()->role('personalia'))
            ->columns([
            ...
            ->headerActions([
                Action::make('add_personalia')
                    ->label('Tambah User Personalia')
                    ...
                    ->action(function (array $data) {
                        ...
                        if (!$user->hasRole($role)) {
                            ...
                            Notification::make()->title('Akses Personalia Berhasil Ditambahkan')->success()->send();
                        } else {
                            Notification::make()->title('User ini sudah memiliki akses Personalia')->warning()->send();
                        }
                    })
            ])
            ->recordActions([
                DeleteAction::make()
                    ...
                    ->modalHeading('Hapus Akses Personalia?')
                    ->modalDescription('User ini tidak akan bisa mengakses menu Personalia lagi, namun akun User tetap ada.')
                    ->action(function (User $record) {
                        $record->removeRole('personalia');
                        Notification::make()->title('Akses Personalia Dihapus')->success()->send();
                    })
            ])
            ->toolbarActions([
                //
    ...
    {
        return view('livewire.personalia.list-personalia');
    }
}
